...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GITHUB do AUTOZAP que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador AUTOZAP, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Autozap\n"
  printf "   [1] Atualizar Autozap\n"
  printf "   [2] Deletar Autozap\n"
  printf "   [3] Bloquear Autozap\n"
  printf "   [4] Desbloquear Autozap\n"
  printf "   [5] Alter. dominio Autozap\n"
  printf "\n"
  read -p "> " option
